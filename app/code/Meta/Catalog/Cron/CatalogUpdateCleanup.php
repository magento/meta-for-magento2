...
class CatalogUpdateCleanup
{
    /**
     * @var FacebookCatalogUpdate
     */
    private $fbeCatalogUpdateResourceModel;
    ...
    /**
     * Execute function for Category Update Cleanup
     *
     * @return void
     */
    public function execute()
    {
        $this->fbeCatalogUpdateResourceModel->cleanupTable();
    }
}
