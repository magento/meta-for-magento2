...
namespace Meta\Catalog\Model\Config;
...
class ProductAttributes
{
    ...
    public function setAttributesConfig()
    {
        $this->attributesConfig = [
            'facebook_age_group' => [
                'label' => 'Age Group',
                'source' => 'Meta\Catalog\Model\Config\Source\Product\AgeGroup',
            ...
            'facebook_gender' => [
                'label' => 'Gender',
                'source' => 'Meta\Catalog\Model\Config\Source\Product\Gender',
            ...
            'facebook_pattern' => [
                'label' => 'Pattern',
                'source' => 'Meta\Catalog\Model\Config\Source\Product\Pattern',
            ...
            'facebook_decor_style' => [
                'label' => 'Decor Style',
                'source' => 'Meta\Catalog\Model\Config\Source\Product\DecorStyle',
            ...
            'facebook_is_assembly_required' => [
                ...
                'source' => 'Meta\Catalog\Model\Config\Source\Product\Assembly',
    ...
    public function getUnitPriceAttributesConfig()
    {
        return [
            ...
            'per_unit_price_unit' => [
                ...
                'label' => 'Price Unit',
                'input' => 'select',
                'source' => 'Meta\Catalog\Model\Config\Source\Product\PriceUnit',
                'required' => false,
                'sort_order' => -2,
                'global' => ScopedAttributeInterface::SCOPE_WEBSITE,
                'used_in_product_listing' => false,
